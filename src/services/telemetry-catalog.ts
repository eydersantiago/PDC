...
export const EVENT_CATALOG: EventCatalogEntry[] = [
  // --- Decisiones del tutor (backend) --------------------------------------
  {
    ...
    purpose: "Trazabilidad de la decision: evento de politica, tipo de intervencion, etapa de ayuda, motivo, latencia y servidor de inferencia que respondio (GPU de Google Cloud o Mac del laboratorio).",
    fields: ["decisionId", "channel", "policyEventType", "interventionType", "helpStage", "reasonCode", "blocked", "latencyMs", "errorHash", "contextHash", "exerciseHash", "metadata.worker"],
...
export const FIELD_DICTIONARY: FieldDictionaryEntry[] = [
  ...
  { field: "metadata", type: "jsonb", description: "Datos adicionales del evento, filtrados por lista blanca de claves.", sensitivity: "ninguna", minimization: "Solo claves de la lista blanca (trigger, pageType, applyMode, linesChanged, line, cached, blocked, scope, mode, reason, worker, editorHost, editorUi...)." },
